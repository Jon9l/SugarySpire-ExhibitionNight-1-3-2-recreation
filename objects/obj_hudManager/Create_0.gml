	...
	tvAnimations = function(arg0)
	{
		...
		switch (player_state)
		{
			...
			case PlayerState.machroll:
				...
				if player_state = PlayerState.machroll && arg0.mach3Roll <= 0
				{
					var from_transition = [global.TvSprPlayer_Mach2, global.TvSprPlayer_Mach3, global.TvSprPlayer_Mach4]
					tvNormalStates = true
					...
					if (queuedSprite == global.TvSprPlayer_Idle && tvIdleAnimationBuffer-- <= 0 && global.Combo < 10)
					{
						tvIdleAnimationBuffer = choose(500, 450, 400, 550)
						queuedSprite = choose(global.TvSprPlayer_IdleAnim1, global.TvSprPlayer_IdleAnim2)
						image_index = 0
				...
				else
				{
					...
					if (player_state == PlayerState.mach3 || player_state == PlayerState.climbwall || (player_state == PlayerState.machslide && arg0.sprite_index == arg0.spr_machslideboost3) || (player_state == PlayerState.machroll && arg0.mach3Roll > 0))
